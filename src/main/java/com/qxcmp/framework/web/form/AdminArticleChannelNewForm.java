 ...
 * @author aaric
 */
@FormView(caption = "新建栏目", enctype = "multipart/form-data")
@Data
public class AdminArticleChannelNewForm {
    ...
    @FormViewField(label = "栏目管理员", type = InputFiledType.SELECT, consumeCandidate = true, candidateTextIndex = "username", candidateValueIndex = "id")
