...
public class AdminSpiderPageController extends QXCMPBackendController {
    ...
    public ResponseEntity<RestfulResponse> privilegeEnable(@PathVariable String name) {
    ...
    public ResponseEntity<RestfulResponse> privilegeDisable(@PathVariable String name) {
